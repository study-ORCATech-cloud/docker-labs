...
# Define paths where Docker will mount our secrets
...
# Function to read secrets from files mounted by Docker
# The files must be mounted as a volume in your docker-compose.yml
